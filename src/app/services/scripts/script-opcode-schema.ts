...
const rows: Array<[number,string,string,readonly ScriptArgumentDescriptor[]]> = [
  ...
  [16,'EV_ABORT_MOVE','Stop Movement',[]],[17,'EV_ENTITY_FRAME','Set Entity Frame',a('u8','u8','u8')],[18,'EV_ADV_CAMERAKEY','Camera Keyframe',a('u8')],
  ...
  [21,'EV_DOOROP','Door Operation',a('u16')],[22,'EV_MONSTERFLAGOP','Monster Flags',[primitive('u8','entity','entity-index'),primitive('u8','operation')]],
  [23,'EV_EVENTOP','Modify Event',[primitive('u16be','event','tile-event-index')]],[24,'EV_HIDE','Hide/Show Entity',[primitive('u8','entity','entity-index')]],
  [25,'EV_DROPITEM','Spawn/Drop Item',a('u16','u8')],[26,'EV_PREVSTATE','Dec State Var',a('u8')],[27,'EV_NEXTSTATE','Inc State Var',a('u8')],
  [28,'EV_WAKEMONSTER','Wake Monster',[primitive('u8','entity','entity-index')]],[29,'EV_SHOW_PLAYERATTACK','Show Weapon Anim',a('u8')],[30,'EV_MONSTER_PARTICLES','Bleed Effect',a('u8')],
  [31,'EV_SPAWN_PARTICLES','Spawn Particles',a('u8','u16','u8')],[32,'EV_FADEOP','Screen Fade',a('u16')],[33,'EV_GIVEITEM','Give Player Item',a('u8','u8','s8')],
  ...
  [42,'EV_MARKTILE','Mark AutoMap',a('u16')],[43,'EV_UPDATEJOURNAL','Update Quest',a('u8','u8')],[44,'EV_BRIBE_ENTITY','Bribe',[]],
  [45,'EV_PLAYER_ADD_STAT','Buff Player',a('u8')],[46,'EV_PLAYER_ADD_RECIPE','Add Recipe',a('u16')],[47,'EV_RESPAWN_MONSTER','Respawn',a('u16','u8','u8')],
  ...
  [72,'EV_MAKE_CORPSE','Create Corpse',a('u16','u8','u8')],[73,'EV_INVENTORY_OP','Mod Inventory',a('u8')],[74,'EV_END_GAME','Game Over',[]],
  [75,'EV_LERPSPRITEPARABOLA','Jump Sprite',[primitive('s32be','packedEntity','entity-index',packed(0xff,16)),primitive('u16be','duration')]],
  ...
  [80,'EV_START_ARMORREPAIR','Repair Armor',[]],[81,'EV_FORCE_BOT_RETURN','Recall Bot',[]],[82,'EV_UNMARKTILE','Unmark Map',a('u16')],
  ...
  [95,'EV_LERPSPRITEPARABOLA_SCALE','Jump Scale',[primitive('s32be','packedEntity','entity-index',packed(0xff,16)),primitive('u16be','duration'),primitive('u8','scale')]],
