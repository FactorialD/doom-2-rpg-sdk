...
export class MapSerializer {
    ...
    serialize(mapData: MapData, originalBuffer: ArrayBuffer): Uint8Array {
        this.mapData = mapData;
        this.reader = new ByteStream(originalBuffer);
    ...
    private writeGeometryStructures() {
        const peekReader = new ByteStream(this.reader.view.buffer);
    ...
    private skipOldSprites() {
        ...
        this.reader.skip(4); // Marker
        this.reader.skip(oldTotal * 3); // X,Y,Info
        this.reader.skip(4 + oldTotal * 2); // Flags
        this.reader.skip(4 + oldNumZ); // Z
        this.reader.skip(4 + oldNumZ); // Extra
    }
    ...
    private skipOldScripts() {
        ...
        this.readMarker(); this.reader.skip(12 * 2); // Static Funcs
        this.readMarker(); this.reader.skip(oldNumTileEvents * 8); // Tile Events
        this.readMarker(); this.reader.skip(oldByteCodeSize); // Bytecode
    }
    ...
    private readMarker() { this.reader.readInt(); }
